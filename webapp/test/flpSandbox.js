		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Navigation &amp; Pass Parameters App Demo",
									"targetURL": "#josecarlosgznavigation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"josecarlosgznavigation-display": {
								"semanticObject": "josecarlosgznavigation",
								"action": "display",
								"description": "UI5 application to practice navigating between views and passing values as parameters",
								"title": "Navigation &amp; Pass Parameters App Demo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=josecarlosgz.navigation",
									"url": sap.ui.require.toUrl("josecarlosgz/navigation")
								}
							}
						}
					}
